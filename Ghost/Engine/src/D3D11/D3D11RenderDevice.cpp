...
namespace ghost
{
    ...
    DepthStencilTargetPtr D3D11RenderDevice::createDepthStencilTarget(unsigned w, unsigned h, bool msaa, bool floatDepth, bool srv)
    {
        return MAKE_SMART_POINTER(D3D11DepthStencilTarget, w, h, msaa, floatDepth, srv);
    }
}